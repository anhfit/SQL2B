...
public interface SQLiteVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitBinary_operator(@NotNull SQLiteParser.Binary_operatorContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#parsing_point}.
	 * 
	 * @param ctx
	 *            the parse tree
	 * @return the visitor result
	 */
	T visitParsing_point(@NotNull SQLiteParser.Parsing_pointContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitCommon_table_expression(
