...
public interface SQLiteListener extends ParseTreeListener {
	 ...
	 *            the parse tree
	 */
	void enterCreate_virtual_table_stmt(
	 ...
	 *            the parse tree
	 */
	void exitCreate_virtual_table_stmt(
			@NotNull SQLiteParser.Create_virtual_table_stmtContext ctx);
	 ...
	 *            the parse tree
	 */
	void enterBinary_operator(@NotNull SQLiteParser.Binary_operatorContext ctx);
	 ...
	 *            the parse tree
	 */
	void exitBinary_operator(@NotNull SQLiteParser.Binary_operatorContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#parsing_point}.
	 * 
	 * @param ctx
	 *            the parse tree
	 */
	void enterParsing_point(@NotNull SQLiteParser.Parsing_pointContext ctx);

	/**
	 * Exit a parse tree produced by {@link SQLiteParser#parsing_point}.
	 * 
	 * @param ctx
	 *            the parse tree
	 */
	void exitParsing_point(@NotNull SQLiteParser.Parsing_pointContext ctx);
	 ...
	 *            the parse tree
	 */
	void enterCompound_select_stmt(
	 ...
	 *            the parse tree
	 */
	void enterFactored_select_stmt(
	 ...
	 *            the parse tree
	 */
	void enterCommon_table_expression(
	 ...
	 *            the parse tree
	 */
	void exitCommon_table_expression(
			@NotNull SQLiteParser.Common_table_expressionContext ctx);
	 ...
	 *            the parse tree
	 */
	void enterQualified_table_name(
